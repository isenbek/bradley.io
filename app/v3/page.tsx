        ...
        <div className="v3-wrap">
          ...
          <V3Reveal delay={220}>
            <div className="v3-hero__meta">
              <Link href="/v3/projects" className="v3-btn v3-btn--primary">
                See the work →
              </Link>
              <Link href="/v3/services" className="v3-btn v3-btn--ghost">
                Hire me
              </Link>
            </div>
          </V3Reveal>
          ...
          >
            {[
              ...
              },
              {
                ...
                blurb: "Public dashboard tracking every commit, session, and message shipped with Claude.",
                href: "/ai-pilot",
              },
              {
                tag: "Beta",
                tagColor: "gold",
                title: "MCP Catalog",
                blurb: "A reading room for the Model Context Protocol ecosystem.",
                href: "/mcp",
              },
              {
                tag: "Research",
                tagColor: "blue",
                title: "Papers",
                blurb: "Notes, write-ups, and longer-form pieces from the lab.",
                href: "/papers",
              },
            ].map((item, i) => (
        ...
        <div className="v3-wrap">
          <V3Reveal>
            ...
            >
              ...
              <Link href="/v3/contact" className="v3-btn v3-btn--primary">
                Book a call →
              </Link>
            </div>
          </V3Reveal>
