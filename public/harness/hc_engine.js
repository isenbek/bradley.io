...
export class Vault {
    ...
    decrypt(envelope) {
        ...
        const ret = wasm.vault_decrypt(this.__wbg_ptr, ptr0, len0);
        if (ret[3]) {
    ...
    encrypt(plaintext) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vault_encrypt(this.__wbg_ptr, ptr0, len0);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    ...
    constructor(words) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vault_new(ptr0, len0);
        if (ret[2]) {
    ...
    stash_id() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.vault_stash_id(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
if (Symbol.dispose) Vault.prototype[Symbol.dispose] = Vault.prototype.free;
 ...
 * @param {number | null} [remote_version]
 * @returns {boolean}
 */
export function may_push(local_version, remote_version) {
    const ret = wasm.may_push(local_version, isLikeNone(remote_version) ? Number.MAX_SAFE_INTEGER : (remote_version) >>> 0);
    return ret !== 0;
}
 ...
 * @returns {string[]}
 */
export function migrations_from(from) {
    const ret = wasm.migrations_from(from);
 ...
 * @returns {string}
 */
export function normalize_seed(words) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(words, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.normalize_seed(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function stmt(name) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.stmt(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./hc_engine_bg.js": import0,
    };
}

const VaultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_vault_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('hc_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
